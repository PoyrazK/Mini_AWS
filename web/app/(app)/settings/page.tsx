        ...
        <Card title="Account Profile">
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            ...
            <div>
              ...
              <div style={{ color: 'var(--text-secondary)' }}>root@miniaws.local</div>
            </div>
        ...
        <Card title="API Access">
           <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
             <p style={{ color: 'var(--text-secondary)', fontSize: '14px', lineHeight: '1.5' }}>
               Use these keys to access Mini AWS via the CLI or SDKs. Do not share your secret key.
             </p>
             <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px', background: 'var(--system-gray-6)', borderRadius: '8px' }}>
               <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                 ...
                 <code style={{ fontSize: '13px', fontFamily: 'Menlo, monospace' }}>AKIA-MINI-AWS-DEMO-KEY</code>
               </div>
