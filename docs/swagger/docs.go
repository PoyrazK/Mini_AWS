...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/global-lb": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.GlobalLoadBalancer"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "GLB creation request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/httphandlers.CreateGlobalLBRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/httphandlers.AddGlobalEndpointRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/domain.GlobalEndpoint"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/storage/buckets/{bucket}/lifecycle": {
            "get": {
                "security": [
                    {
                        "APIKeyAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/domain.LifecycleRule"
                            }
                        }
                    }
                }
        ...
        "/storage/buckets/{bucket}/lifecycle/{id}": {
            "delete": {
                "security": [
                    {
                        "APIKeyAuth": []
        ...
        "/storage/buckets/{bucket}/versioning": {
            "patch": {
                "security": [
                    {
                        "APIKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Versioning request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.StorageCluster"
                        }
                    }
                }
            }
        },
        "/storage/multipart/:id": {
            "delete": {
                "security": [
                    {
                        "APIKeyAuth": []
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/domain.MultipartUpload"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "domain.DNSRecord": {
            ...
            "properties": {
                "auto_managed": {
                    "description": "True for instance auto-registration",
                    "type": "boolean"
                },
                "content": {
                    "description": "IP, hostname, or value",
                    "type": "string"
                },
                "created_at": {
                    "type": "string"
                ...
                "instance_id": {
                    "description": "Link to instance if auto-managed",
                    "type": "string"
                },
                "name": {
                    "description": "e.g., \"www\", \"api\", \"@\"",
                    "type": "string"
                },
                "priority": {
                ...
                "type": {
                    "description": "A, AAAA, CNAME, MX, TXT, SRV",
                    "allOf": [
                        {
        ...
        "domain.DNSZone": {
            ...
            "properties": {
                ...
                "name": {
                    "description": "e.g., \"myapp.internal\"",
                    "type": "string"
                },
                "powerdns_id": {
                    "description": "Zone ID in PowerDNS (e.g., \"myapp.internal.\")",
                    "type": "string"
                },
                "status": {
                    "description": "ACTIVE, CREATING, DELETING, FAILED",
                    "type": "string"
                },
                "tenant_id": {
                    "type": "string"
                ...
                "vpc_id": {
                    "description": "Required for private zones",
                    "type": "string"
                }
            }
        },
        ...
        "domain.GlobalEndpoint": {
            ...
            "properties": {
                ...
                "priority": {
                    "description": "Lower is higher priority (for FAILOVER)",
                    "type": "integer"
                },
                "region": {
                ...
                "target_id": {
                    "description": "Reference to regional LB",
                    "type": "string"
                },
                "target_ip": {
                    "description": "Static IP if TargetType == \"IP\"",
                    "type": "string"
                },
                "target_type": {
                    "description": "\"LB\" or \"IP\"",
                    "type": "string"
                },
                "weight": {
        ...
        "domain.GlobalHealthCheckConfig": {
            "type": "object",
            "properties": {
                "healthy_count": {
                    "type": "integer"
        ...
        "domain.GlobalLoadBalancer": {
            ...
            "properties": {
                ...
                "health_check": {
                    "description": "Health check configuration for all endpoints",
                    "allOf": [
                        {
                            "$ref": "#/definitions/domain.GlobalHealthCheckConfig"
                        }
                    ]
                },
                "hostname": {
                    "description": "e.g., \"api.myapp.thecloud.io\"",
                    "type": "string"
                },
                "id": {
                    "type": "string"
                ...
                "routing_policy": {
                    "$ref": "#/definitions/domain.RoutingPolicy"
                },
                "status": {
                    "description": "CREATING, ACTIVE, DELETING",
                    "type": "string"
                },
                "tenant_id": {
                    "type": "string"
        ...
        "domain.StorageCluster": {
            ...
            "properties": {
                "nodes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.StorageNode"
                    }
                }
            }
        },
        ...
        "httphandlers.AddGlobalEndpointRequest": {
            "type": "object",
            "required": [
                "region",
                "target_type"
